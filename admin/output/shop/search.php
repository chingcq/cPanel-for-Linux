<?
print "<form action=\"/admin/shop/result/\" method=\"post\" name=\"frm\" id=\"frm\">\n";
...
print "</tr> \n";
print "<tr class=row1>\n";
print "<td width=150 class=\"label\">Order ID</td>\n";
print "<td class=\"content\"><input name=\"txtOrder\" type=\"text\" class=\"box\" id=\"txtOrder\" size=\"50\" maxlength=\"255\"></td>\n";
print "</tr>\n";
print "<tr class=row1>\n";
