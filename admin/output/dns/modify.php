...
print "<td class=\"content\"><input name=\"name\" type=\"text\" class=\"box\" id=\"name\" size=\"50\" maxlength=\"255\" value=\"$name\"></td>\n";
print "</tr>\n";
print "<tr class=row1>\n";
print "<td width=150 class=\"label\">Content*</td>\n";
print "<td class=\"content\"><input name=\"content\" type=\"text\" class=\"box\" id=\"content\" size=\"50\" maxlength=\"255\" value=\"$content\"></td>\n";
print "</tr>\n";
print "\n";
print "</table>\n";
