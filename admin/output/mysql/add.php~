...
print "</tr>\n";
print "<tr class=row1> \n";
print "<td width=150 class=\"label\">MySQL password*</td>\n";
print "<td class=\"content\"><input name=\"txtpass\" type=\"text\" class=\"box\" id=\"txtpass\" size=\"50\" maxlength=\"255\"></td>\n";
print "</tr>\n";
print "<tr class=row1> \n";
print "<td width=150 class=\"label\">MySQL DB*</td>\n";
print "<td class=\"content\"><input name=\"txtdb\" type=\"text\" class=\"box\" id=\"txtdb\" size=\"50\" maxlength=\"255\"></td>\n";
print "</tr>\n";
print "<tr class=row1> \n";
