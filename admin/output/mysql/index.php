...
$sql_2 = "SELECT * FROM `tbl_mysql` ORDER BY 'mysql_id' DESC";
...
?>
  ...
  <tr>
   <td colspan="5" align="right"><input name="btn" type="button" id="btn" value="Add" class="box" onClick=location.href='<? echo WEB_ROOT; echo "admin/mysql/add/"; ?>'></td>
  </tr>
</table>
<p>&nbsp;</p>
