...
Class Input_mysql Extends Input_Base {
	...
	if(!isset($_SESSION['errorMessage']))
		...
		if(isset($_POST['btn']))
		{
			$_POST['txtdb'] = $_POST['txtID'] . '_' . $_POST['txtdb'];
			$array = array('type' 			=> 'add',
						   'class'			=> 'mysql',
								'task' 			=> array(	'otherfields' => 0,
															...
															'match'	=> 0),
								'otherfields' 	=> '',
								'empty'			=> 'txtmysql|txtDomain|txtID|txtpass|txtdb',
								'trim' 			=> 'txtmysql|txtDomain|txtID|txtpass|txtdb',
								'nontrim' 		=> '',
								'validate' 		=> array(	0 => 'txtmysql|LandN|Please enter mysql user name in correct format',
