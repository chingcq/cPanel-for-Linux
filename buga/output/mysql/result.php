...
<?
		...
		switch ($action) {
			case 'deleteEntry' :
				...
				echo "<script>document.location='" . WEB_ROOT . "buga/mysql/result'</script>";
			break;
		}
class search
{
    ...
    public function showresult()
    {
		...
		if ($this->numrows > 0) {
			...
			foreach ($this->registry['conn']->query($this->sql) as $row){
				...
				print '<td width="70" align="center"><a href="' . WEB_ROOT . 'buga/mysql/modify/&id=' . $row['mysql_id'] . '">Modify</a></td>';
